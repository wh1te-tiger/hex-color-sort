...
namespace Scripts
{
    ...
    {
        private readonly Dictionary<int, Stack<GameObject>> _cachedObjects;
        private readonly Dictionary<int, int> _cachedIds;
        private readonly int _capacity;

        public PoolContainer(int capacity)
        {
            _capacity = capacity;
            _cachedObjects = new Dictionary<int, Stack<GameObject>>(capacity);
            _cachedIds = new Dictionary<int, int>(capacity);
        }
        ...
        public GameObject Get(GameObject prefab)
        {
            ...
            var createdPrefab = Object.Instantiate(prefab);
            var createdKey = createdPrefab.GetInstanceID();
        ...
        public void Release(GameObject go, bool resetParent = false)
        {
            if ( resetParent ) go.transform.SetParent(null);
